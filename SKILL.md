...
>   ① 定义句之后的分句，禁止直接以动词或介词开头。**先通过 note、context 等字段查证描述对象的身份（性别、物种、属性），再选择恰当的主语补出。**未明确指代对象的性别或物种时，禁用"他/她/它"，改用"该××"等中性表达
...
> 1. **定义句后缺主语**：定义句之后的分句，是否补出了主语？若直接以动词/介词开头则为错误。**同时检查：是否先查证了描述对象身份再选主语；身份不明时是否避免了擅用"他/她/它"**
